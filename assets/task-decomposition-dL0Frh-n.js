import{n as a,stamp as $,head as y,r1 as d,uid as m,outPanel as u,emptyOut as f,callout as r,text as p,number as w,delBtn as k,select as x,field as c,panel as v,area as D,addBtn as T}from"./kit-DV3I2Ncm.js";import{I as A,e as l}from"./views-B7S8XgD6.js";import"./data-DpGBRXZo.js";const b="A step you cannot start tomorrow morning is not a step — it is a heading. Keep splitting until every line names a physical first action.",Y={id:"task-decomposition",name:"Task Decomposition",blurb:"Break something too big to start into steps you can actually begin.",icon:"layers",accent:"forest",group:"Working",purpose:"Converts a vague, heavy project into a sequence with a real first move.",when:["You have avoided something for more than a week",'You do not know what "starting" would even look like',"A deadline exists but no plan does"],reads:b,initial:()=>({goal:"",done:"",deadline:"",steps:[{id:m(),name:"",hours:1,blocked:"no",by:""}]}),form(o){const n=o.steps.map((s,e)=>`
