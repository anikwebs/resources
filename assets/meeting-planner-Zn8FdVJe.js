import{stamp as x,n as i,head as g,uid as w,outPanel as $,emptyOut as k,callout as o,text as d,delBtn as M,select as A,number as r,panel as u,field as l,area as f,addBtn as T}from"./kit-B_He1EBw.js";import{e as m}from"./views-CF56ohTL.js";import"./data-CbaeBgJo.js";const v="A meeting without a decision to make is a broadcast, and a broadcast should be a document. The test is not whether it was useful — it is whether it needed everyone in the room.",O={id:"meeting-planner",name:"Meeting Planner",blurb:"Establish whether the meeting is needed, then make it short.",icon:"users",accent:"atlas",group:"Communicating",purpose:"Produces an agenda that names a decision, an owner and a cost.",when:["Before booking anything with more than two people","A recurring meeting has lost its purpose","You are attending something and cannot tell why"],reads:v,initial:()=>({title:"",decision:"",mins:30,people:4,rate:0,prep:"",items:[{id:w(),what:"",mins:10,owner:"",kind:"decide"}],outcome:""}),form(e){const a=e.items.map((s,t)=>`
