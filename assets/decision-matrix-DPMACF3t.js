import{n as d,stamp as T,head as $,r2 as y,uid as l,outPanel as v,emptyOut as W,callout as m,tblWrap as q,bar as C,text as g,range as f,delBtn as b,panel as u,field as M,addBtn as x}from"./kit-DV3I2Ncm.js";import{e as c}from"./views-B7S8XgD6.js";import"./data-DpGBRXZo.js";const A="A matrix does not decide for you. If the top two are within about 5%, the honest reading is that they are equivalent on the things you listed — either find the criterion you left out, or pick the more reversible option and move on.",I={id:"decision-matrix",name:"Decision Matrix",blurb:"Score real options against criteria you weight yourself.",icon:"scale",accent:"forest",group:"Deciding",purpose:'Turns "I keep going round in circles" into a visible comparison you can argue with.',when:["Two or more genuine options and no obvious winner","You suspect one loud factor is drowning out several quiet ones","You will have to explain the decision to someone later"],reads:A,initial:()=>({question:"",criteria:[{id:l(),name:"Money",weight:3},{id:l(),name:"Time cost",weight:3},{id:l(),name:"What it leads to",weight:4},{id:l(),name:"Risk if it goes wrong",weight:3}],options:[{id:l(),name:"Option A",scores:{}},{id:l(),name:"Option B",scores:{}}]}),form(t){const a=t.criteria.map((n,e)=>`
